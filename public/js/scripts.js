            ...
            table.on('draw.dt', function () {
                ...
                for (let i = 0; i < botones.length; i++) {
                    botones[i].addEventListener('click', function (e) {
                        $.ajax({
                            type: "GET",
                            url: "http://127.0.0.1:8000/incidencias/show/" + botones[i].getAttribute('data-id'),
                            dataType: "json",
                ...
                for (let i = 0; i < botones_revisar.length; i++) {
                    botones_revisar[i].addEventListener('click', function (e) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "http://127.0.0.1:8000/incidencias/revisar/" + botones_revisar[i].getAttribute('data-id'),
                            dataType: "json",
                            headers: {
                ...
                for (let i = 0; i < botones_editar.length; i++) {
                    botones_editar[i].addEventListener('click', function (e) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "http://127.0.0.1:8000/incidencias/editar/" + botones_editar[i].getAttribute('data-id'),
                            dataType: "json",
                            headers: {
                                'X-CSRF-TOKEN': csrfToken
                            },
